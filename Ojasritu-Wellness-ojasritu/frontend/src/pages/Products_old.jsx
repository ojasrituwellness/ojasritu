                  ...
                  {filteredProducts.map((product) => {
                    ...
                    return (
                      <div key={product.id} className="product-card">
                        ...
                        <Link to={product.slug ? `/products/${product.slug}` : "/products"} className="product-image" aria-label={product.name || "Product image"}>
                          <img
                            src={imageUrl}
                        ...
                        <h3>
                          <Link to={product.slug ? `/products/${product.slug}` : "/products"} aria-label={product.name || "Product details"}>
